...
def main():
    ...
    scripts = [
        ("backend/build_vector_db_fixed.py", "Построение векторной базы данных"),
        ("backend/style_analyzer_smart.py", "Анализ стиля и генерация промта"),
        ("backend/3_telegram_bot.py", "Запуск Telegram бота")
    ]
